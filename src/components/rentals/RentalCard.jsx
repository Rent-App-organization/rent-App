...
import { FaRegHeart, FaStar, FaChevronLeft, FaChevronRight } from "react-icons/fa";
...
const RentalCard = ({ rental }) => {
    ...
    return (
        <div onClick={handleClick}
            className="bg-white shadow-lg rounded-xl overflow-hidden relative cursor-pointer">
            {/* Favorite Button */}
