...
const FormPage = () => {
  ...
  const productId = useSelector((state) => state.product ? state.product.productId : null);
  ...
  const inputClasses = "w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 focus:border-blue-500 focus:bg-white focus:outline-none transition duration-200";
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="text-center mb-10">
            <h1 className="text-4xl font-bold text-gray-900 mb-3">Villa Rental Information</h1>
            <p className="text-lg text-gray-600">Please provide your details to complete the booking</p>
          </div>
          ...
          <form className="space-y-8" onSubmit={handleSubmit(onSubmit)}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div>
                ...
                <input
                  type="number"
                  className={`${inputClasses} ${errors.numGuests ? 'border-red-500' : ''}`}
                  {...register('numGuests', {
                  ...
                  placeholder="e.g., 4"
                />
                {errors.numGuests && <p className={errorClasses}>{errors.numGuests.message}</p>}
              </div>
