...
// import { updateUserRole } from "../../redux/authSlice"; 
...
//       await update(userRef, { role: "owner", ownerDetails: formData });

//       dispatch(updateUserRole("owner"));

//       toast.success("Your request to become an owner has been submitted successfully!");
...
//         Fill out the form below to apply as a property owner.
//       </p>
...
//         {/* Upload Document */}
//         <div>
//           <label className="block text-sm font-medium text-gray-700">Upload ID or Ownership Proof</label>
//           <input
//             type="file"
