...
const PropertyDetails = () => {
  ...
  const amenities = [
    ...
    { icon: <Coffee className="w-6 h-6" />, name: "Kitchen" },
  ];
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
          {/* Title Section */}
          <div className="mb-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">{property.title || "Luxury Villa for Rent"}</h1>
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6">
                ...
                <p className="text-gray-600 leading-relaxed">
                  {property.description || 
                    "Luxurious fully furnished villa located in a quiet and upscale area. Features modern design and stunning views. Includes a private pool and spacious garden, perfect for families seeking comfort and privacy."}
                </p>
              </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                  {amenities.map((amenity, index) => (
                    <div key={index} className="flex flex-col items-center gap-2 p-4 bg-gray-50 rounded-xl">
                ...
                <div className="bg-white rounded-2xl shadow-lg p-6">
                  ...
                  <div className="p-4 bg-gray-50 rounded-xl mb-4">
                    <div className="flex items-center gap-3 text-gray-700">
                      ...
                      <span>Available: {property.date || "Year-round"}</span>
                    </div>
                  </div>
                  <button
                    onClick={() => setIsBookingOpen(true)}
                    className="w-full bg-blue-600 text-white py-3 px-4 rounded-xl hover:bg-blue-700 transition-all duration-300"
                  >
                    Book Now
                  </button>
                </div>
